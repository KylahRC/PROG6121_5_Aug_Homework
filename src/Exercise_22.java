...
{
//    was this meant to be the same as Ex 21? It sounds like it to me
//    I just wrote the same code, I dont see the difference between the questions
...
//        decides what response is needed
        if (lengthsAreTheSame)
        {
            if (valuesAreTheSame)
            {
                JOptionPane.showMessageDialog(null, "The two lists are identical.");
            }
            else
            {
                JOptionPane.showMessageDialog(null, "The two lists are not identical.");
            }
        }
        else
        {
